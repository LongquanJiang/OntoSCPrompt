...
if __name__ == '__main__':
    ...
    dblp_qald_train = load_dataset("./src/datasets/dblp_qald/dblp_qald.py", split='train')
    dblp_qald_valid = load_dataset("./src/datasets/dblp_qald/dblp_qald.py", split='validation')
    dblp_qald_test = load_dataset("./src/datasets/dblp_qald/dblp_qald.py", split='test')
    ...
    output = open("./consistency_check_outputs/dblp_qald.txt", "w")

    train_structures = check_consistency(dblp_qald_train, tokenizer, output)
    valid_structures = check_consistency(dblp_qald_valid, tokenizer, output)
    test_structures = check_consistency(dblp_qald_test, tokenizer, output)
