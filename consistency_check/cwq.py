...
if __name__ == '__main__':
    ...
    cwq_train = load_dataset('./src/datasets/cwq/cwq.py', split='train')
    cwq_valid = load_dataset('./src/datasets/cwq/cwq.py', split='validation')
    cwq_test = load_dataset('./src/datasets/cwq/cwq.py', split='test')
    ...
    output = open("./consistency_check_outputs/cwq.txt", "w")

    train_structures = check_consistency(cwq_train, tokenizer, output)
    valid_structures = check_consistency(cwq_valid, tokenizer, output)
    test_structures = check_consistency(cwq_test, tokenizer, output)
